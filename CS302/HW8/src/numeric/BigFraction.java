...
public class BigFraction extends Number
{
  ...
  {
    assert n != null      : "arguments cannot be null";
    num = n;
  ...
  /**
   * Method called in BFOperation to simplify a fraction.
   * 
   * @return BigFraction
   */
  public BigFraction simplifyFrac() {
      ...
      BigFraction reduced = new BigFraction(num, denom);
  ...
  /**
   * Returns the reciprocal of a BigFraction when called.
   * 
   * @return BigFraction
   */
  public BigFraction flip() {
      
      BigInteger newNum = this.getDenominator();
      BigInteger newDenom = this.getNumerator();
      
      BigFraction flipped = new BigFraction(newNum, newDenom);
